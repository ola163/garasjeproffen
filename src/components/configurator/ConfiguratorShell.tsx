...
const DEMO_STEPS: Array<{
  ...
  doorWidth: number; doorHeight: number; doorColor: "hvit" | "sort";
  ...
  return (
    ...
    <div className={`flex ${mobileLandscape ? "" : "flex-col lg:flex-row lg:h-[calc(100dvh-11rem)]"}`}>
      ...
      <div className={`relative bg-stone-100 ${
        ...
        {(viewMode === "test" || viewMode === "demo") && <GarageViewer {...viewerProps} demoDoorOpen={false} doorColor={viewMode === "demo" ? DEMO_STEPS[demoStep].doorColor : viewerProps.doorColor} />}
      ...
      <div className={mobileLandscape ? "hidden" : "flex w-full lg:w-[360px] lg:shrink-0 flex-col border-t lg:border-t-0 lg:border-l border-gray-200 bg-white"}>
        <div ref={scrollContainerRef} className="flex-1 overflow-y-auto p-2 lg:p-6">
          ...
          <div className="mt-8" ref={quoteRef}>
            <QuoteForm configuration={configuration} pricing={pricing} packageType={packageType} roofType={roofType} buildingType={buildingType} addedElements={addedElements} grunnarbeid={grunnarbeid ?? undefined} open={quoteOpen} address={selectedAddress ?? undefined} mapCenter={mapCenter} mapRotation={mapRotation} doorColor={doorColor} />
          </div>
