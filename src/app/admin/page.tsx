    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-3xl px-4 py-6 sm:py-12 sm:px-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          {/* Oppsett / Migrasjoner */}
          <Link href="/admin/setup" className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
            ...
            <h2 className="text-base font-semibold text-gray-900 group-hover:text-gray-600">Oppsett</h2>
            <p className="mt-1 text-sm text-gray-500">Kjør databasemigrasjoner og systemoppsett.</p>
            <p className="mt-4 text-xs font-medium text-gray-500 group-hover:underline">Åpne →</p>
          </Link>
