    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-3xl px-4 py-6 sm:py-12 sm:px-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          {/* Prissammenligner */}
          <Link href="/admin/prissammenligner" className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
            ...
            <h2 className="text-base font-semibold text-gray-900 group-hover:text-emerald-600">Prissammenligner</h2>
            <p className="mt-1 text-sm text-gray-500">Sammenlign tilbud fra leverandører side ved side med rangering per vare.</p>
            <p className="mt-4 text-xs font-medium text-emerald-500 group-hover:underline">Åpne →</p>
          </Link>

          {/* GP Varekatalog */}
          <Link href="/admin/katalog" className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100">
              <svg className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
              </svg>
            </div>
            <h2 className="text-base font-semibold text-gray-900 group-hover:text-blue-600">GP Varekatalog</h2>
            <p className="mt-1 text-sm text-gray-500">Intern produktkatalog med GPV-varenr for material, festemidler, isolasjon osv.</p>
          ...
          {/* Utlegg */}
          <Link href="/admin/utlegg" className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-green-100">
              <svg className="h-6 w-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
            </div>
            <h2 className="text-base font-semibold text-gray-900 group-hover:text-green-600">Utlegg</h2>
            <p className="mt-1 text-sm text-gray-500">Registrer utlegg med kvitteringsbilde, beløp og kategori. Knyttbart til ticket.</p>
          ...
          {/* Proffkunder */}
          <Link href="/proffkunder" className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-orange-100">
              <svg className="h-6 w-6 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
            </div>
            <h2 className="text-base font-semibold text-gray-900 group-hover:text-orange-600">Proffkunder</h2>
            <p className="mt-1 text-sm text-gray-500">Rekkegarasjer, utbyggersamarbeid og B2B-løsninger for profesjonelle kunder.</p>
            <p className="mt-4 text-xs font-medium text-orange-500 group-hover:underline">Åpne →</p>
          </Link>
